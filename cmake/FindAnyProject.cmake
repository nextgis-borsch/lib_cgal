...
function(find_anyproject name)
    ...
    if(WITH_${name})
        ...
        if(WITH_${name}_EXTERNAL)
            ...
            find_package_upper(${name} ${FIND_PROJECT_ARG} CONFIG QUIET)
            if(${IS_FOUND})
                ...
                find_package_upper(${name} ${FIND_PROJECT_ARG})
            endif()
        endif()
        ...
        if(${IS_FOUND})
            ...
            mark_as_advanced(${IS_FOUND} ${UPPER_NAME}_INCLUDE_DIRS ${UPPER_NAME}_INCLUDE_DIR ${UPPER_NAME}_LIBRARIES ${UPPER_NAME}_LIBRARY)
